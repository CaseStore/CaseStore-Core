...
namespace CaseStoreOutputFieldTypeStringBundle\Entity;
 ...
 * @ORM\Entity(repositoryClass="CaseStoreOutputFieldTypeStringBundle\Repository\OutputFieldValueStringRepository")
